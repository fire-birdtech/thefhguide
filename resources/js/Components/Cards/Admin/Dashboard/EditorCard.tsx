...
export default function EditorCard ({ editor }) {
    return (
        <div className="group w-full border-2 border-transparent flex flex-col items-center justify-start rounded-lg bg-white text-center shadow">
            ...
            <div className="w-full">
                {editor.unpublished_assignmments.length || editor.unpublished_drafts.length ? (
                                    ...
                                    <div className="w-full bg-transparent pt-2 px-4">
                                        <ul className="flex flex-col w-full">
                                            {editor.unpublished_assignments.map((assignment) => (
                                                <li key={assignment.id} className="truncate w-full flex items-center justify-between text-xs py-1">
