        ...
        <div class="relative">
            <div class="inline-flex divide-x divide-indigo-700 rounded-md shadow-sm">
                <div class="inline-flex divide-x divide-indigo-700 rounded-md shadow-sm">
                    ...
                    <ListboxButton class="inline-flex items-center rounded-l-none rounded-r-md bg-indigo-600 p-2 text-sm font-medium text-white hover:bg-indigo-700 focus:ring focus:ring-indigo-500 focus:ring-opacity-40">
