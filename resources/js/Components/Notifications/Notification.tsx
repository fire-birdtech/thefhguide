...
export default function Notification(): ReactElement {
  ...
  let { notification }: { notification: NotificationType } = usePage().props.flash;
  ...
  return (
    <div aria-live="assertive" className="pointer-events-none fixed inset-0 flex items-end ox-6 py-6 sm:items-start sm:p-6">
      <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
        <Transition
          show={show && notification !== null}
          as={Fragment}
