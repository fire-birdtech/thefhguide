...
const destroy = () => {
    router.delete(route('editor.choices.destroy', [props.choice.id]));
}
                ...
                <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-3">
                            <Link class="hover:text-gray-600" :href="route('editor.goals.show', [choice.goal.id])"> {{ choice.goal.name }} </Link>
                        </dd>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6">
