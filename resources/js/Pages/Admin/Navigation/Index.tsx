...
import SortableTree from "@/Components/DragAndDrop/Tree/SortableTree";
import {TreeItem} from "@/types/dragAndDrop";

export default function NavigationIndex ({ auth }: PageProps): ReactElement {
  const { navigation } = usePage().props
  const initialItems: TreeItem[] = navigation.map((item: { name: string, children: TreeItem[] }) => ({
    id: item.name,
