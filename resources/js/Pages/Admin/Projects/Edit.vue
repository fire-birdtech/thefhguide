...
const selected = ref(props.partners[
    props.partners.findIndex(
        partner => partner.id === props.project.projectable.id
    )
]);
...
<template>
    ...
    <AdminLayout>
        <div class="w-full py-8 px-4 sm:px-6 lg:px-8">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mt-2"> Edit Project: {{ project.name }} </h3>
