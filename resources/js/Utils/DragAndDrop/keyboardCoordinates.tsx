...
import {getProjection} from "@/Utils/DragAndDrop/index";
import {SensorContext} from "@/types/dragAndDrop";
...
export const sortableTreeKeyboardCoordinates: (
  ...
  indicator?: boolean,
) => KeyboardCoordinateGetter = (context, indentationWidth, indicator) => (
  event,
  {
    currentCoordinates,
